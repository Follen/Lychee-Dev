...
function ns.CreateObjectPage(parent, ui)
    ...
    local function CreateRow(index)
        local row = ui.CreateListRow(listContent, ROW_HEIGHT)
        ...
        row:SetScript("OnEnter", function(self)
            self.isHovered = true
            ui.SetListRowState(self, false, true)
        end)
        row:SetScript("OnLeave", function(self)
            self.isHovered = nil
            ui.SetListRowState(self, false, false)
        end)
