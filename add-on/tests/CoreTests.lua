...
assert(migratedEvidence and migratedEvidence.schema == "lychee.evidence.v1"
        and migratedEvidence.source.kind == "performance_capture"
...
assert(ns.GetExport("LYCHEE-LEGACY-0004").source.kind == "performance_capture"
        and ns.GetExport("LYCHEE-LEGACY-0004").payload.content == "legacy export",
    "legacy performance evidence was lost on database reinitialization")
