...
ns.EventCatalogData = {
    ...
    "BC_26_COLD_SWAP_FEATURE_ENABLED_CHANGED", "newEnabled, oldEnabled",
    "BC_26_EXPERIENCE_CHANGED", "newExperience, oldExperience",
    ...
    "CHAT_COMBAT_MSG_ARENA_POINTS_GAIN", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_DISABLED_CHANGED", "disabled",
    "CHAT_DISABLED_CHANGE_FAILED", "disabled",
    "CHAT_LOGGING_CHANGED", "whichLog, isEnabled",
    "CHAT_MSG_ACHIEVEMENT", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    ...
    "CHAT_MSG_AFK", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_BG_SYSTEM_ALLIANCE", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_BG_SYSTEM_HORDE", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_BG_SYSTEM_NEUTRAL", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_BN", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_BN_INLINE_TOAST_ALERT", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_BN_INLINE_TOAST_BROADCAST", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_BN_INLINE_TOAST_BROADCAST_INFORM", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_BN_INLINE_TOAST_CONVERSATION", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_BN_WHISPER", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_BN_WHISPER_INFORM", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_BN_WHISPER_PLAYER_OFFLINE", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_CHANNEL", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_CHANNEL_JOIN", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_CHANNEL_LEAVE", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_CHANNEL_LEAVE_PREVENTED", "channelName",
    "CHAT_MSG_CHANNEL_LIST", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_CHANNEL_NOTICE", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_CHANNEL_NOTICE_USER", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_COLLECTED_APPEARANCE", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_COMBAT_FACTION_CHANGE", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_COMBAT_HONOR_GAIN", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_COMBAT_MISC_INFO", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_COMBAT_XP_GAIN", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_COMMUNITIES_CHANNEL", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_CURRENCY", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_DND", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_EMOTE", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_FILTERED", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_GUILD", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_GUILD_ACHIEVEMENT", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_GUILD_DISCORD", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_GUILD_ITEM_LOOTED", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_IGNORED", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_INSTANCE_CHAT", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_INSTANCE_CHAT_LEADER", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_LOOT", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_MONEY", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_MONSTER_EMOTE", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_MONSTER_PARTY", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_MONSTER_SAY", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_MONSTER_WHISPER", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_MONSTER_YELL", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_OFFICER", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_OPENING", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_PARTY", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_PARTY_LEADER", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_PET_BATTLE_COMBAT_LOG", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_PET_BATTLE_INFO", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_PET_INFO", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_PING", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_RAID", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_RAID_BOSS_EMOTE", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_RAID_BOSS_WHISPER", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_RAID_LEADER", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_RAID_WARNING", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_RESTRICTED", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_SAY", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_SKILL", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_SYSTEM", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_TARGETICONS", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_TEXT_EMOTE", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_TRADESKILLS", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_VOICE_TEXT", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_WHISPER", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_WHISPER_INFORM", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    "CHAT_MSG_YELL", "text, playerName, languageName, channelName, playerName2, specialFlags, zoneChannelID, channelIndex, channelBaseName, languageID, lineID, guid, bnSenderID, isMobile, isSubtitle, hideSenderInLetterbox, suppressRaidIcons, discordInfo",
    ...
    "CONFIRM_BATTLE_NET_FRIEND_INVITE_SHOW", "name, friendLevel",
    "CONFIRM_BEFORE_USE", "",
    ...
    "DELETE_ITEM_CONFIRM", "itemName, qualityID, bonding, questWarn, itemGUID",
    "DELVES_ACCOUNT_DATA_ELEMENT_CHANGED", "",
    "DELVE_ASSIST_ACTION", "data",
    "DIEL_CYCLE_CHANGED", "isDayTime",
    "DISABLE_DECLINE_GUILD_INVITE", "",
    "DISABLE_LOW_LEVEL_RAID", "",
    "DISABLE_TAXI_BENCHMARK", "",
    "DISABLE_XP_GAIN", "",
    "DISCORD_GUILD_ACHIEVEMENT", "achievementID",
    ...
    "GAMEPAD_POSSESS_BAR_OVERRIDE_CHANGED", "oldOverride, newOverride",
    "GAMEPAD_STANCE_BAR_OVERRIDE_CHANGED", "oldOverride, newOverride",
    ...
    "GAME_PAD_ALLOW_HOVER_EVENTS_WITH_FREE_LOOK_CHANGED", "enabled",
    ...
    "GROUP_BUFF_VISUAL_ALERTS_CHANGED", "visualAlerts",
    ...
    "GUILD_PREFERRED_PLAY_SETTINGS_UPDATED", "status, preferredLocaleID, preferredDatacenterLocalityID, lastPreferredLocaleChangeDate, lastPreferredDatacenterLocalityChangeDate",
    "GUILD_RANKS_UPDATE", "",
    ...
    "HIDDEN_GROUP_BUFFS_CHANGED", "spellIDs",
    ...
    "HOUSING_BLUEPRINT_COLLECTION_FAILURE", "result",
    "HOUSING_BLUEPRINT_COLLECTION_RECEIVED", "collection",
    "HOUSING_BLUEPRINT_CONTENTS_FAILURE", "blueprintShareCode, result",
    "HOUSING_BLUEPRINT_CONTENTS_RECEIVED", "contentInfo",
    "HOUSING_BLUEPRINT_DELETE_FAILURE", "blueprintID, result",
    "HOUSING_BLUEPRINT_DELETE_SUCCESS", "blueprintID",
    "HOUSING_BLUEPRINT_EXPORT_FAILURE", "result",
    "HOUSING_BLUEPRINT_EXPORT_SUCCESS", "blueprintShareCode",
    "HOUSING_BLUEPRINT_IMPORT_FAILURE", "result",
    "HOUSING_BLUEPRINT_IMPORT_STARTED", "",
    "HOUSING_BLUEPRINT_IMPORT_SUCCESS", "",
    "HOUSING_BLUEPRINT_RENAME_FAILURE", "blueprintID, result",
    "HOUSING_BLUEPRINT_RENAME_SUCCESS", "blueprintID, name",
    ...
    "HOUSING_LAYOUT_FLOORPLAN_SELECTION_CHANGED", "hasSelection, roomID, blueprintShareCode",
    "HOUSING_LAYOUT_OCCUPIED_FLOOR_RANGE_CHANGED", "lowestFloor, highestFloor",
    ...
    "HOUSING_LAYOUT_ROOM_RECEIVED", "playAddedSound",
    ...
    "HOUSING_NEW_DECOR_PLACE_COMPLETE", "decorGUID",
    ...
    "IGNORELIST_UPDATE", "",
    "IGNORE_NEIGHBORHOOD_RESPONSE", "success, neighborhoodGuid",
    ...
    "INPUT_DEVICE_INTERFACE_TRANSITION", "newMode, oldMode",
    ...
    "LFG_LIST_CENSORED_ACTIVE_ENTRY_UPDATE", "isCensored",
    ...
    "LFG_LIST_SHOW_SEARCH", "activityIDsFilter",
    ...
    "LOOT_HISTORY_UPDATE_DROP", "encounterID, lootListKey",
    ...
    "SPELL_UPDATE_COOLDOWN", "spellID, baseSpellID, category, startRecoveryCategory, itemID",
    ...
    "UNIT_PING_PIN_ADDED", "guid, uiTextureKit",
    "UNIT_PING_PIN_REMOVED", "guid",
    ...
    "VIEWED_TRANSMOG_OUTFIT_SLOT_OPTION_CHANGED", "slot, option",
