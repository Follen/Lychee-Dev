...
ns.ProbeQueue = {
    ...
    Busy = function()
        ...
        if not plain(definitions) or not plain(definitions.entries) then return nil, "queue_invalid_format" end
        for _ in pairs(definitions.entries) do return true end
        return false
    end,
    ...
    Acknowledge = function(requestId, sequence)
        ...
        return ns.ReportStore.Acknowledge({
